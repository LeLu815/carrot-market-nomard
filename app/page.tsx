export default function Home() {
  return (
    <main className="bg-gray-200 h-screen flex items-center justify-center p-5 dark:bg-gray-800">
      <div className="bg-white shadow-lg p-5 rounded-3xl w-full max-w-screen-sm dark:bg-gray-600">
        ...
        <div className="my-2 flex items-center gap-2">
          <span className="bg-green-400 text-white uppercase px-2.5 py-1.5 text-xs font-medium rounded-full hover:bg-green-500 hover:scale-110 transition">
            Today
          </span>
